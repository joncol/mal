...
/* package step0-0.1.0.0 */
#define VERSION_step0 "0.1.0.0"
#define MIN_VERSION_step0(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "step0-0.1.0.0-9V42r1AySSi5kROt9F3iMd"

#define CURRENT_PACKAGE_KEY "step0-0.1.0.0-9V42r1AySSi5kROt9F3iMd"
